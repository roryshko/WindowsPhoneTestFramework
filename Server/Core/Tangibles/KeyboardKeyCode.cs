// ----------------------------------------------------------------------
// <copyright file="KeyboardKeyCode.cs" company="Expensify">
...
{
    /// <summary>
    /// This is based on the list of VirtualKeyCodes (see: http://msdn.microsoft.com/en-us/library/ms645540(VS.85).aspx)
    /// copied from http://inputsimulator.codeplex.com/SourceControl/changeset/view/d624821ef19c#WindowsInput%2fNative%2fVirtualKeyCode.cs
    /// </summary>
    public enum KeyboardKeyCode : ushort // UInt16
    {
        /// <summary>
        /// Left mouse button
        /// </summary>
